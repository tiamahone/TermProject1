...
<body bgcolor = "#beb8b8">
    <form id="form1" runat="server">
        ...
        <asp:Label ID="lblName" runat="server" Style="z-index: 1; left: 100px; top: 300px; position: absolute " Text= "Name:"></asp:Label>
        <asp:TextBox ID="txtName" runat="server" Style="z-index: 1; left: 250px; top: 300px; position: absolute"></asp:TextBox>
        <asp:Label ID="lblEmail" runat="server" Style="z-index: 1; left: 100px; top: 330px; position: absolute " Text= "Email Address:"></asp:Label>
        <asp:TextBox ID="txtEmail" runat="server" TextMode="Email" Style="z-index: 1; left: 250px; top: 330px; position: absolute"></asp:TextBox>
        <asp:Label ID="lblPassword" runat="server" Style="z-index: 1; left: 100px; top: 360px; position: absolute" Text="Password:"></asp:Label>
        ...
        <asp:Label ID="lblConfirm" runat="server" Style="z-index: 1; left: 100px; top: 390px; position: absolute" Text="Confirm Password:"></asp:Label>
        ...
        <asp:Label ID="lblPhone" runat="server" Style="z-index: 1; left: 100px; top: 420px; position: absolute" Text="Phone Number:"></asp:Label>
